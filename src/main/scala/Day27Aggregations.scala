...
//  df.printSchema() //done by readDataWithView
  ...
  println("Count for InvoiceNo")
  df.select(count("InvoiceNo"), countDistinct("InvoiceNo"),approx_count_distinct("InvoiceNo")).show()
  println("Count for CustomerID")
  df.select(count("CustomerID"), countDistinct("CustomerID"),approx_count_distinct("CustomerID")).show()
  println("Count for UnitPrice")
  df.select(count("UnitPrice"), countDistinct("UnitPrice"),approx_count_distinct("UnitPrice")).show()
